...
@AllArgsConstructor
public class RootRepositoryRenderDataBuilder implements RenderDataBuilder {
    ...
    public Map<String, Object> renderData() {
        ...
        imports.add("cn.codependency.framework.puzzle.repository.aggregate.AggregateRoot");
        ...
        imports.add("cn.codependency.framework.puzzle.common.id.IdGenerator");
        imports.add("cn.codependency.framework.puzzle.common.id.IdGeneratorFactory");
        imports.add("cn.codependency.framework.puzzle.repository.Repository");
        imports.add("cn.codependency.framework.puzzle.repository.RepositoryUtils");
        imports.add("cn.codependency.framework.puzzle.repository.annotation.SaveMapping");
        imports.add("cn.codependency.framework.puzzle.repository.annotation.QueryMapping");
